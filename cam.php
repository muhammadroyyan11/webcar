...
$form .= "<form method=\"POST\" action=\"cam.php\">";
$form .= "<table class =\"style1\">";
$form .= "<tr>";
$form .= "<td>CAR Number :</td><td><select name=\"inum\"><option value=\"\"></option>";
$gpi = "select distinct IssNumber from tblCARDTL1 where CAMID = $id";
...
$form1 = "<td><form method=\"POST\" action=\"cam.php\">";
$form1 .= "<td>Dept</td><td>";
...
$display = "";
	...
	if($select1Result)
	{
		...
		if($totalRows != 0)
		{
			...
			$display .= "<th class=\"t2\">Originator</th><th class=\"t2\">Originator Manager</th><th class=\"t2\">In Charge Manager</th><th class=\"t2\">Departement</th></tr></thead>";
		}
		...
		while($row = mysql_fetch_array($select1Result))
		{
			...
			$geti = "select IssNumber from tblCARDTL1 where CAMID = $id";
		...
		if($count == 0)
		{
		print "<center><p class = \"p\"> CAR is not found</center></p><br/>";
		} 
		else
		{
		print "<center><p class = \"p\">$count CAR files is found</center></p><br/>";
		}
...
<p></p>
 <table width="78" border="0">
     <tr>
       <td><form name="form2" method="post" action="cam.php">
	   <input type="hidden" name="group" value="<?php echo $group; ?>">
	   <input type="hidden" name="id" value="<?php echo $id; ?>">
