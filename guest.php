...
$form .= "<td>Rank :</td>";       
$form .= "<td><select name=\"category\" id=\"category\">";
$form .= "<option value=\"\"></option>";
$form .= "<option value=\"Non Confirmance\">Non Confirmance</option>";
$form .= "<option value=\"Major\">Major</option>";
$form .= "<option value=\"Minor\">Minor</option>";
$form .= "<option value=\"Observation\">Observation</option>";
$form .= "<option value=\"SFI\">SFI</option>";
$form .= "<option value=\"RC\">RC</option>";
$form .= "</select></td>";


$form .= "<td>Category :</td>";  
/* 	$form .= "<td><select name=\"catid\" size=\"150px\"><option value=\"\"></option>";*/
	$form .= "<td><select name=\"category\" >";
	$form .= "<option value=\"\"></option>";
$form .= "<option value=\"Non Confirmance\">Non Confirmance</option>";
$form .= "<option value=\"Major\">Major</option>";
$form .= "<option value=\"Minor\">Minor</option>";
...
$form .= "<option value=\"RC\">RC</option>";
	...
	/*  $sid = "select CatID,Category from tblcardtl2 order by CatID ASC";
	  $scat = mysql_query($sid);
	  while($r = mysql_fetch_array($scat))
	  { 
	  	$catid = $r['CatID'];
		$cata = $r['Category'];
		$form .= "<option value=\"$catid\">$cata</option>";
	  } */
...
$form1 .= "<table align =\"left\"><tr><td>Depart</td><td>";
...
<body>
    ...
    <table height="107" border="0" align="center" bgcolor="#99CCFF" class="tbl">
      <tr>
        <!--
	 ...
	 <form name="form1" method="post" action="viewarc.php">
        ...
        <td class="t5" ><form name="form1" method="post" action="summary.php">
            <input type="hidden" name="group" value="<?php echo $group;?>">
            <input type="hidden" name="id" value="<?php echo $id;?>">
      ...
      <tr>
        <td height="30" colspan="2" class="t5"><?php  print $form; ?></td>
      </tr>
      <tr>
        <td class="t5"><?php print $form1; ?></td>
        <td class="t5" align="center"><form name="form1" method="post" action="login.php">
            <br/>
