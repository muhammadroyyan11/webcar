...
<html>
<head>
<title>Adding New Originator Staff</title>
...
if($_SERVER['REQUEST_METHOD'] == "POST") //add button is clicked
{
	...
	$section = $_POST['section'];
		...
		$sql = "INSERT INTO tblOS ";
    	$sql .= "(OSFirstName,OSLastName,OSDept,OSSec)";
    	$sql .= "VALUES ( ";
		...
		if($result)
		{
			print "<center><p class=\"style2\">".$fname." ".$lname." "."has been added to originator staff list</p></style></center>";
		}
...
//display form to add originator staff
?>
...
<p align="center" class="style3"><strong> New Originator Staff </strong></p>
<table width="280" border="0" align="center">
  <tr>
    <td width="440" class="style1"><form name="form1" method="post" action="newostaff.php">
