...
<html>
<head>
<title>New Originator Manager</title>
...
if($_SERVER['REQUEST_METHOD'] == "POST") //add button is clicked
{
	...
	$section = $_POST['section'];
		...
		$sql = "INSERT INTO tblOM ";
    	$sql .= "(OMFirstName,OMLastName,OMDept,OMSec)";
    	$sql .= "VALUES ( ";
		...
		if($result)
		{
			print "<center><p class=\"style2\">".$fname." ".$lname." "."has been added to originator manager list</p></style></center>";
		}
...
//display form to add originator manager
?>
...
<p align="center" class="style3"><strong> New Originator Manager </strong></p>
<table width="280" border="0" align="center">
  <tr>
    <td width="440" class="style1"><form name="form1" method="post" action="newomngr.php">
