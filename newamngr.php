...
<html>
<head>
<title>New Audited Manager</title>
...
if($_SERVER['REQUEST_METHOD'] == "POST") //add button is clicked
{
	...
	$section = $_POST['section'];
		...
		$sql = "INSERT INTO tblAM ";
    	$sql .= "(AMFirstName,AMLastName,AMDept,AMSec)";
    	$sql .= "VALUES ( ";
		...
		if($result)
		{
			print "<center><p class=\"style2\">".$fname." ".$lname." "."has been added to audited manager list</p></style></center>";
		}
...
//display form to add audited manager
?>
...
<p align="center" class="style3"><strong> New Audited Manager </strong></p>
<table width="280" border="0" align="center">
  <tr>
    <td width="440" class="style1"><form name="form1" method="post" action="newamngr.php">
