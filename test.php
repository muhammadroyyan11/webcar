...
if($month == 1){ 
   $dt .= mktime(0,0,0,12,$day,($year -1)); 
} else { 
   $dt .= mktime(0,0,0,($month -1),$day,$year); 
} 
$previous_link = "<form method=\"post\" action=\"test.php\"><input type=\"hidden\" name=\"dt\" value=\"$dt\"><input type = \"submit\" value =\"Prev\"></form>";
/*
...
$next_link = "<form method=\"post\" action=\"test.php\"><input type=\"hidden\" name=\"dt\" value=\"$dt\"><input type = \"submit\" value =\"Next\"></form>";
/*
