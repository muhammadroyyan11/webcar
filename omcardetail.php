...
if(isset($_POST['what']))
{
	...
	if($_POST['what'] == "update")
	{
		...
		$update = "update tblCAR set OMStat = '$omstatus',RejectBy = '$r' where IssNumber='$inum'";
		$updateResult = mysql_query($update);
		if($updateResult)
		{
			print "<p class=\"style2\">Originator Manager status has been updated</p>";
		}
		else
		{
			print mysql_error();
...
<body>
<table width="334" border="0" class="style1">
    <tr>
      <td width="63"><form name="form1" method="post" action="om.php">
...
<form method="post" action="omcardetail.php">
<input type="hidden" name="group" value="<?php echo $group; ?>">
			...
			while($row = mysql_fetch_array($select6Result))
			{
				...
				*/
				...
				while($rca = mysql_fetch_array($gcar))
				{
					...
					$display2 .= "<form method=\"post\" action=\"omcardetail.php\"><tr><td valign=\"top\">$ac</td><td valign=\"top\">$dbnm</td><td valign=\"top\">";
