...
$form3 .= "<input type=\"hidden\" name=\"id\" value=\"$id\">";
...
$select1 = "SELECT A.*,B.CatID FROM tblCAR as A INNER JOIN tblcardtl2 as B ON A.IssNumber=B.IssNumber Where A.IssNumber = '$inum' ";
$select1Result = mysql_query($select1);
	...
	if($select1Result)
	{
		...
		if ($cid != "")
		{
			$q1 = "select Category from tblCategory where CatID = ". $cid ;
			/* echo $q1; */
			$r1 = mysql_query($q1);
			if ($r1)
			{
...
<?php
			...
			{
?>
<td valign="top"><table class="tbl"><tr><td class="t2">Attachment</td></tr><tr><td>
<?php
//display files
	$afid = "";
	$fn = "";
...
if($select5Result)
		{
			$display = "<table border=\"0\" class=\"tbl\"><tr><th class=\"t2\">Name</th><th class=\"t2\">Departemen</th></tr>";
		...
		print "</td><td width=\"15\"></td><td><p class=\"p\" align=\"center\">Corrective Action Team</p>";
			...
			if($select7Result)
			{
			$display3 = "<table class=\"tbl\" border=\"0\" ><tr><th class=\"t2\">Name</th><th class=\"t2\">Departement</th><th class=\"t2\">Section</th></tr>";	
			...
			*/
			while($row = mysql_fetch_array($select6Result))
			{
				...
				*/
				...
				$display2 .= "<td width=\"500\"  valign=\"top\" rowspan=\"7\" class = \"t1\">$findings</td>";
				$display2 .= "<td width=\"500\"  valign=\"top\" rowspan=\"7\" class = \"t1\">$analysis</td>";
				...
				$display2 .= "<tr valign=\"top\"><td class = \"t2\">Ranking</td><td class = \"t1\">$category</td></tr>";
				...
				$display2 .= "<tr  valign=\"top\"><td class = \"t2\">Category :</td><td class = \"t1\">$cata</td>";
