...
<body>
<form name="form1" method="post" action="printreport.php">
...
<?php
			...
			if($select6Result)
			{
			$display2 = "<table border=\"1\" class=\"style1\" align=\"center\">";
			/*
			...
			*/
			while($row = mysql_fetch_array($select6Result))
			{
				...
				*/
				...
				$display2 .= "<td width=\"500\" class = \"style11\">Findings</td>";
				$display2 .= "<td width=\"500\" class = \"style11\">Analysis</td>";
				$display2 .= "<td width=\"500\" class = \"style11\">Corrective Action</td>";
				...
				$display2 .= "<td  valign=\"top\" rowspan=\"7\" width=\"500\" class = \"style1\"><table border = \"1\">";
				$caid11 = "";
				...
				while($rca = mysql_fetch_array($gcar))
				{
					...
					$display2 .= "<tr><td>$ac</td><td>$dbnm</td><td>$cas</td><td>";
					if($cas == "closed")
					{
					$display2 .= "$cafd";
					}
