...
<html>
<head>
<title>New Corrective Action Manager</title>
...
if($_SERVER['REQUEST_METHOD'] == "POST") //add button is clicked
{
	...
	$departemen = $_POST['departemen'];
		...
		$sql = "INSERT INTO tblCAM ";
    	$sql .= "(CAMFirstName,CAMLastName,CAMDept)";
    	$sql .= "VALUES ( ";
    	$sql .= "'$fname','$lname','$departemen')"; 
    	$result = mysql_query($sql, $connection);
		
		if($result)
		{
			print "<center><p class=\"style2\">".$fname." ".$lname." "."has been added to corrective action manager list</p></style></center>";
		}
...
//display form to add corrective action manager
?>
...
<p align="center" class="style3"><strong> New Corrective Action Manager </strong></p>
<table width="280" border="0" align="center">
  <tr>
    <td width="440" class="style1"><form name="form1" method="post" action="newcamngr.php">
