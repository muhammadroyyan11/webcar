...
$form1 = "<td><form method=\"POST\" action=\"am.php\">";
$form1 .= "<td>Dept</td><td>";
$form1 .= "<select name=\"sdept\"><option value=\"\"></option>";

$gam = "select distinct AMID from tblCAR where AMID = $id";
...
print "<br/><br/>";
			...
			if($_POST['what'] == "search")
			{
				...
				if(($_POST['inum'] == "") && ($_POST['stat'] != ""))
				{
					$select1 .=" WHERE CARStatus = '$stat'";
             		...
             		$select1 .= " AND AMID = $id ORDER BY CARID DESC";
			}
    	}
        elseif(isset($_POST['sort']))
		{
			if($_POST['sort'] == "sort")
			{
				$select1 = "select * from tblCAR WHERE AMID = $id order by CARID DESC";
			}
		}
		else
		{
			$select1 = "select * from tblCAR WHERE AMID = $id order by CARID DESC LIMIT $offset,50";
		}
...
$display = "";
	...
	if($select1Result)
	{
	     ...
	     if($totalRows == 0)
		{
			print "<p class=\"p\">$totalRows CAR files is found</p>";
		}
		...
		if(isset($_POST['sort']))
		{
			...
			$count++;
			            ...
			            $display .= "<form method=\"post\" action=\"amcardetail.php\">";
...
<p></p>
 <table width="78" border="0">
     <tr>
       <td><form name="form2" method="post" action="am.php">
	   <input type="hidden" name="group" value="<?php echo $group; ?>">
	   <input type="hidden" name="id" value="<?php echo $id; ?>">
...
{ 
	 ...
	 { 
          ...
          $displayNext .= "<td><form name=\"form1\" method=\"post\" action=\"am.php\">";
...
{ 
     ...
     { 
          ...
          $displayPrevious .= "<td><form name=\"form1\" method=\"post\" action=\"am.php\">";
...
{ 
   $id = $_POST['id'];
   $countQuery = "SELECT count(CARID) as carCount FROM tblCAR WHERE AMID = $id"; 
