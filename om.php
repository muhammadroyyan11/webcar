...
<html>
<head>
<title>Originator Manager Menu</title>
...
//$form .= "<option value=\"partially closed\">partially closed</option><option value=\"rejected\">rejected</option>";
$form .= "</select></td>";
//$form .= "<td>Topic:</td><td>";
//$form .= "<input type=\"text\" name=\"stopic\" size=\"50\"";
//$form .= "</td>";
...
$form1 = "<td><form method=\"POST\" action=\"om.php\">";
$form1 .= "<td>Dept</td><td>";
$form1 .= "<select name=\"sdept\"><option value=\"\"></option>";

$gam = "select distinct AMID from tblCAR where OMID = $id";
...
print "<br/>";
			...
			if($_POST['what'] == "search")
			{
				...
				if(($_POST['inum'] == "") && ($_POST['stat'] != ""))
				{
					$select1 .=" WHERE CARStatus = '$stat'";
             		...
             		//$select1 .= " AND OMID = $id  or RequestBy = '$fname' ORDER BY CARID DESC";
					$select1 .= " AND OMID = $id  ORDER BY CARID DESC";
			}
    	}
        elseif(isset($_POST['sort']))
		{
			if($_POST['sort'] == "sort")
			{
				//$select1 = "select * from tblCAR WHERE OMID = $id or RequestBy = '$fname' ORDER BY CARID DESC";
				$select1 = "select * from tblCAR WHERE OMID = $id ORDER BY CARID DESC";
			}
		}
		else
		{
			//$select1 = "select * from tblCAR WHERE OMID = $id or RequestBy = '$fname' ORDER BY CARID DESC LIMIT $offset,50";
			$select1 = "select * from tblCAR WHERE OMID = $id ORDER BY CARID DESC LIMIT $offset,50";
		}
		...
		if(isset($_POST['sort']))
		{
			...
			if($sdept == $amDept)
			{
				...
				$view = 0;
					    ...
					    $display .= "<form method=\"post\" action=\"omcardetail.php\">";
...
<p></p>
 <table width="78" border="0">
     <tr>
       <td><form name="form2" method="post" action="om.php">
	   <input type="hidden" name="group" value="<?php echo $group; ?>">
	   <input type="hidden" name="id" value="<?php echo $id; ?>">
...
{ 
	...
	else 
	{
	 ...
	 { 
          ...
          $displayNext .= "<td><form name=\"form1\" method=\"post\" action=\"om.php\">";
...
{ 
	...
	else 
	{
     ...
     { 
          ...
          $displayPrevious .= "<td><form name=\"form1\" method=\"post\" action=\"om.php\">";
...
{ 
  ...
  // $countQuery = "SELECT count(CARID) as carCount FROM tblCAR WHERE OMID = $id or RequestBy = '$fname1'"; 
  $countQuery = "SELECT count(CARID) as carCount FROM tblCAR WHERE OMID = $id"; 
