...
*/
			...
			if($_POST['what'] == "search")
			{
				...
				$select1 .= " WHERE A.IssNumber like '$inum1' And A.CARStatus like '$stat' and B.Category like '$category' And B.Category like '$catid' ";		   
		...
		{
			$select1 = "select * from tblCAR WHERE CARStatus != 'cancel' ORDER BY CARID DESC LIMIT $offset,30";
		}
